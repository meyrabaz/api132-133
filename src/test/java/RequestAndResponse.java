...
public class RequestAndResponse {
  ...
  /*
    ...
    public static void main(String[] args) {
        ...
        // How to see "Header" on console or specific part in header.

        System.out.println(response.header("Connection")); // "keep alive" only

        System.out.println(response.headers());

        // How to see Time in console
